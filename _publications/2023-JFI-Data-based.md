...
excerpt: 'This paper considers the \\(\mathcal{L}_2\\) gain optimal problem for a class of discrete-time linear time-invariant with state-disturbance feedback controller and unknown system dynamics.'
date: 2023-02-24
venue: 'Journal of the Franklin Institute'
paperurl: 'https://doi.org/10.1016/j.jfranklin.2023.02.030'
citation: 'Jiamin Wang, Jian Liu, Yuanshi Zheng, and Dong Zhang (2023). &quot;Data-based \\(\mathcal{L}_2\\) gain optimal control for discrete-time system with unknown dynamics.&quot; <i>Journal of the Franklin Institute</i>. 360(6): 4354--4377.'
---
